  ...
  return (
    <Box className={"mt-4 group text-end"}>
      <Box className={"max-w-[70%] inline-block relative mb-2 ml-2.5"}>
        <TbTriangleFilled className="text-[22px] text-[#5a3bff] absolute -bottom-[3px] left-[2px] -translate-x-2/4" />
        ...
        >
          <button ref={buttonRef} className={"relative"}>
            ...
            {menuShow && (
              <Box
                className={
                  "w-[120px] rounded-md p-1 absolute left-2/4 -translate-x-2/4 bottom-[50px] z-[1] shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]"
                }
              >
