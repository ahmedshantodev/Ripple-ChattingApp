  ...
  return messegeType == "normal" ? (
    ...
    <Box className={"mt-4 group text-end"}>
      ...
      <Box className={"max-w-[67%] inline-block relative mb-2 ml-2.5"}>
        <TbTriangleFilled className="text-[22px] text-[#5a3bff] absolute -bottom-[3px] right-[2px] translate-x-2/4" />
        <Typography
          className="text-start font-poppins py-3 pr-6 pl-8 rounded-[10px] bg-[#5a3bff] text-white break-words border-l border-red-400 relative after:content-[''] after:w-[3px] after:h-[calc(100%-24px)] after:bg-[#d0c3ff] after:absolute after:left-4 after:top-2/4 after:-translate-y-2/4 after:rounded-[30px]"
        >
          {messege}
        </Typography>
        <Flex
