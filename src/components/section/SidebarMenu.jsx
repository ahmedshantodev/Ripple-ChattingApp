...
//               }
//             >
//               <HiOutlineUsers className="text-[24px]" /> Groups
//             </NavLink>
//           </ListItem>
//           <ListItem className={"mb-4"}>
//             <NavLink
...
//             className={"w-[138px] py-3 px-4 rounded-[5px] flex items-center gap-x-2 text-[18px] transition-all duration-200 ease-linear hover:bg-[#32375c] hover:text-white cursor-pointer"}
//           >
